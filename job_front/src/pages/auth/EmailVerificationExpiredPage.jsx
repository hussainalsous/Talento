...
export function EmailVerificationExpiredPage() {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ color: '#6b7280', lineHeight: 1.6, marginBottom: '28px' }}>
          This verification link has expired (links are valid for 60 minutes).
        ...
        {status === 'throttled' && (
          <p style={{ marginTop: '10px', color: '#92400e', fontSize: '0.85rem' }}>
        ...
        {status === 'sent' && (
          <p style={{ marginTop: '10px', color: '#15803d', fontSize: '0.85rem' }}>
